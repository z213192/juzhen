...
from Xg_0404 import X_Gorgon0404

import codecs

sys.stdout = codecs.getwriter("utf-8")(sys.stdout.detach())

def search_video_ios(url,proxies,headers,data):

    headers = json.loads(headers)

    head = X_Gorgon0404(data,"","")
...
if __name__ == '__main__':
    ...
    connect = search_video_ios(unquote(sys.argv[1]),proxies,unquote(sys.argv[4]),unquote(sys.argv[5]))
    print(connect)