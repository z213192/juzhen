...
class Browser():
    def __init__(self, **kwargs, ):
        ...
        self.executablePath = kwargs.get("executablePath", r'/usr/bin/chromedriver')
    ...
    def signature(self, keyword, start_date, end_date):
        sign_url = self.browser.execute_script('''
                var e={"url":"https://trendinsight.oceanengine.com/api/open/index/get_multi_keyword_interpretation",
                        "method":"POST",
...
# test
decrtptlx(get_data(keyword = '北京二手车',start_date = "20220409",end_date = "20220509"))
