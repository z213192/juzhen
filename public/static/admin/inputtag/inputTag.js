 ...
 * Name: inputTag
 * Author: cshaptx4869
 * Project: https://github.com/cshaptx4869/inputTag111111111111111
 */
(function (define) {
    define(['jquery'], function ($) {
        ...
        class InputTag {
            ...
            init(options) {
                ...
                !this.elem.attr('placeholder') && this.elem.attr('placeholder', '添加违规词');
            ...
            spanHtml(value) {
                return '<span class="fairy-tag fairy-anim-fadein ' + this.randomColor() + '">' +
                    '<span>' + value + '</span>' +
                    (this.options.permanentData.includes(value) ? '' : '<a href="#" title="删除违规词">&times;</a>') +
                    '</span>';
            }
