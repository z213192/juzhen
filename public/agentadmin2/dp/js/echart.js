$(function () {
    ...
    function dyuser(){
        $.ajax({
            ...
            url: "/agentadmin/api/dyuser",   //SQL数据库文件
            data:{},         //发送给数据库的数据
    ...
    function titledata(){
        $.ajax({
            ...
            // cache:false,
            // contentType:"application/json;charset=utf-8",
            url: "/agentadmin/api/index",   //SQL数据库文件
            data:{},         //发送给数据库的数据
            dataType: "json", //json类型
            error: function() { },
            success: function (result) {
                if (result) {
                    ...
                    document.getElementById("run_task").innerHTML =abc.dianshu;
                    document.getElementById("all_comment").innerHTML =abc.all_comment;
                    document.getElementById("all_task").innerHTML =abc.all_task;
                    document.getElementById("all_video").innerHTML =abc.all_commission;
                    document.getElementById("price").innerHTML =abc.all_price;
                    document.getElementById("use_price").innerHTML =abc.today_price;
                    document.getElementById("all_price").innerHTML =abc.agent_all_price;
                    ...
                    document.getElementById("wan").innerHTML =abc.agent_count;
                    document.getElementById("zan").innerHTML =abc.agent_store_count;
                    document.getElementById("lv").innerHTML =abc.store_count;
    ...
    function echart_2() {
        ...
        $.ajax({
            ...
            // cache:false,
            // contentType:"application/json;charset=utf-8",
            url: "/agentadmin/api/echart_2",   //SQL数据库文件
            data:{},         //发送给数据库的数据
            dataType: "json", //json类型
            error: function() { },
            success: function (result) {
    ...
    function echart_3() {
        ...
        $.ajax({
            ...
            // cache:false,
            // contentType:"application/json;charset=utf-8",
            url: "/agentadmin/api/echart_3",   //SQL数据库文件
            data:{},         //发送给数据库的数据
            dataType: "json", //json类型
            error: function() { },
            success: function (result) {
    ...
    function echarts_4() {
        ...
        $.ajax({
            ...
            // cache:false,
            // contentType:"application/json;charset=utf-8",
            url: "/agentadmin/api/echarts_4",   //SQL数据库文件
            data:{},         //发送给数据库的数据
            dataType: "json", //json类型
            error: function() {},
            success: function (result) {
...
function echarts_2() {
    ...
    $.ajax({
        ...
        // cache:false,
        // contentType:"application/json;charset=utf-8",
        url: "/agentadmin/api/echarts_2",   //SQL数据库文件
        data:{},         //发送给数据库的数据
        dataType: "json", //json类型
        error: function() { },
        success: function (result) {
...
function char4() {
    ...
    $.ajax({
        ...
        // cache:false,
        // contentType:"application/json;charset=utf-8",
        url: "/agentadmin/api/char4",   //SQL数据库文件
        data:{},         //发送给数据库的数据
        dataType: "json", //json类型
        error: function() { },
        success: function (result) {
