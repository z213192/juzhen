            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'realname_name', title: '活动名',operate:'like'},
                        ...
                        {field: 'realname_user', title: '推广', width:300,table: table, formatter: function(value,row,index){
                            html = '<a href="/storeadmin/index?jump_url=realname_user&menu_url=realname_user&realname_id='+row.id+'" class="btn btn-success btn-xs" style="margin-left:5px;"  target="_blank">发送记录</a>\
                            <a href="/storeadmin/realname/qrcode?realname_id='+row.id+'" class="btn btn-success btn-xs btn-dialog" style="margin-left:5px;background-color: #24c1b9;" title="活动码下载">活动码</a>';
                            if(row.type!=1){
