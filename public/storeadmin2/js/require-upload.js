define(['jquery', 'bootstrap', 'dropzone', 'template'], function ($, undefined, Dropzone, Template) {
    var Upload = {
            ...
            config: {
                ...
                previewtpl: '<li style="width:150px;"><a href="<%=fullurl%>" style="width:140px;height:120px;background:unset;border: 1px solid #6a6a71;" data-url="<%=url%>" target="_blank" class="thumbnail"><img src="<%=fullurl%>" style="width:140px;height:110px;" onerror="this.src=\'' + Fast.api.fixurl("ajax/icon") + '?suffix=<%=suffix%>\';this.onerror=null;" class="img-responsive"></a><a href="javascript:;" class="btn btn-danger btn-xs btn-trash"><i class="fa fa-trash"></i></a></li>',
            },
            events: {
                //初始化
                onInit: function () {
                        ...
                        if (preview_id && input_id) {
                            $(document.body).on("keyup change", "#" + input_id, function (e) {
                                ...
                                $.each(inputArr, function (i, j) {
                                    ...
                                    previewtpl = Upload.config.previewtpl ; 
                                    if(suffix == 'mp4'){
                                        previewtpl = '<li style="width:150px;"><a href="<%=fullurl%>" style="width:140px;height:120px;background:unset;border: 1px solid #6a6a71;" data-url="<%=url%>" target="_blank" class="thumbnail"><video src="<%=fullurl%>" style="width:140px;height:110px;" controls="controls" preload="meta" onerror="this.src=\'' + Fast.api.fixurl("ajax/icon") + '?suffix=<%=suffix%>\';this.onerror=null;" class="img-responsive"></video></a><a href="javascript:;" class="btn btn-danger btn-xs btn-trash"><i class="fa fa-trash"></i></a></li>';
                                    }
                                    
                                    var html = tpl ? Template(tpl, data) : Template.render(previewtpl, data);
