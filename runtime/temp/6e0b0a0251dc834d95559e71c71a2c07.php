<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:92:"/www/wwwroot/juzhen.huizhenjiang.com/public/../application/admin/view/member/member_add.html";i:1665470913;s:88:"/www/wwwroot/juzhen.huizhenjiang.com/public/../application/admin/view/public/header.html";i:1660125746;s:88:"/www/wwwroot/juzhen.huizhenjiang.com/public/../application/admin/view/public/footer.html";i:1660125746;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="block-box">
            <div class="col-12">
                <div class="block font13 font8c95b0">
                    <p class="fs14 c666">1、根据提示信息添加会员</p>
            ...
            <div class="col-12">
                <div class="block font13">
                    <form class="form-horizontal" name="userAdd"  method="post" action="<?php echo url('member_add'); ?>">
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                             ...
                             <div class="form-group">
                            <label class="col-sm-2 control-label">请选择会员组：</label>
                            <div class="input-group col-sm-4">
                                <select class="form-control" name="hyz"  >
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <input id="password" type="text" class="form-control" name="password"  required="required">
                            </div>
                        </div>
                         <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <input id="real_name" type="text" required="required" class="form-control" name="real_name" >
