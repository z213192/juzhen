<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:90:"/www/wwwroot/juzhen.huizhenjiang.com/public/../application/admin/view/video/mix_order.html";i:1672804671;s:88:"/www/wwwroot/juzhen.huizhenjiang.com/public/../application/admin/view/public/header.html";i:1660125746;s:88:"/www/wwwroot/juzhen.huizhenjiang.com/public/../application/admin/view/public/footer.html";i:1660125746;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<!--<link href="/static/admin/jquery-hover/css/demo-page.css" rel="stylesheet" media="all">-->
<link href="/static/admin/jquery-hover/css/hover.css" rel="stylesheet" media="all">
        ...
        <div class="block-box">
            <div class="col-12">
                <div class="block font12 font8c95b0">
                    ...
                    <p style="margin:0;color:red">2. 创建混剪完成后，点击 <b>混剪库列表</b> 查看。</p>
                </div>
            </div>
            ...
            .effects {background: #111111;text-align: center;line-height: 35px;padding: 0 5px;border:1px solid #000}
            .effects a{color: #d9d9d9}
            .guige_list{float:left;margin:10px}
        </style>
                    
                    <div class="layui-form-item m-t-md">
                        <label class="layui-form-label">选择混剪类型<span style="color:red;margin:0 5px;">*</span></label>
                        <div class="layui-input-inline">
                            <input type="radio" name="h_type" class="h_type" >高级混剪
                            <input type="radio" name="h_type" class="h_type" style="margin-left:30px;" checked>顺序混剪
                        </div>
                    </div>
                            <div class="layui-form-item m-t-md">
                            ...
                            <div class="layui-form-item m-t-md">
                                ...
                                <div class="effects">
                                    ...
                                    <a href="#" class="hvr-icon-float-away" data-id="<?php echo $vo['id']; ?>" data-name="<?php echo $vo['uname']; ?>"><?php echo $vo['uname']; ?></a>
                                    <?php endforeach; endif; else: echo "" ;endif; ?>
                                </div>
                            </div>  
                        
                            <div class="layui-form-item m-t-md">
                                <label class="layui-form-label">已选素材库<span style="color:red;margin:0 5px;">*</span></label>
                                <ul id="sortable">
                                </ul>
                            </div>
                            <div class="layui-form-item m-t-md">
                            ...
                            <div class="layui-form-item m-t-md">
                                <label class="layui-form-label">选择声音&nbsp;&nbsp;&nbsp;&nbsp;
                                </label>
                            ...
                            <div class="layui-form-item">
                                <label class="layui-form-label">请添加主标题<span style="color:red;margin:0 5px;">*</span></label>
                                <div class="layui-inline">
                                    <textarea rows="10" cols="30" name="yun_ftitle" id="yun_ftitle" style="text-align:left;resize:none;color:#fff;width:250px;height:38px;float:left"  placeholder="在这里可添加主标题"></textarea>
                            ...
                            <div class="layui-form-item">
                                <label class="layui-form-label">请添加副标题<span style="color:red;margin:0 5px;">*</span></label>
                                <div class="layui-inline">
                                    <textarea rows="10" cols="30" name="yun_title" id="yun_title" style="text-align:left;resize:none;color:#fff;width:250px;height:38px;float:left"  placeholder="在这里可添加副标题"></textarea>
...
<script src="/static/admin/JackWeiSlider/js/jackwei.slider.js"></script>
<script type="text/javascript" src="/static/admin/jquerydrag/js/jquery.dragsort-0.5.2.min.js"></script>
...
<script type="text/javascript">
    $("#sortable").dragsort({ dragSelector: "div", dragBetween: true, dragEnd: saveOrder, placeHolderTemplate: "<li class='placeHolder'><div></div></li>" });

    function saveOrder() {
        // var data = $("#sortable li").map(function() { return $(this).children().html(); }).get();
        // $("input[name=sortableSortOrder]").val(data.join("|"));
    };
</script>
<script>
    ...
    $(".hvr-icon-float-away").click(function (){
        ...
        $("#sortable").append('<li class="guige_list" data-id="'+id+'" data-name="'+name+'"><div>'+name+'</div><span class="closeicon"  onclick="removePicture(this)"></span></li>')
    })
</script>
<script type="text/javascript">
    $(function() {
...
<script>
    ...
    $(".h_type").change(function() {
        window.location.href="/admin/video/addindex.html"
    })
    function submit(){
        layer.load(3)
        var sucai_arr = [];
        $(".guige_list").each(function() {
            sucai_arr.push({'id':$(this).attr('data-id'),'name':$(this).attr('data-name')});
        });
        //判断有没有图片或视频
        $.ajax({
            type: "POST",
            url: "/admin/video/sucaipd_order",
            data: {
                sucai_arr:sucai_arr
            },
        ...
        layer.confirm('确认生成？将消耗您'+jinbi+'个积分?', {icon: 3, title:'提示'}, function(index){
            ...
            var apply_data = {
                ...
                yun_jie:yun_jie,
                yun_title:yun_title,
                yun_titlecolor:yun_titlecolor,
                yun_titlesize:yun_titlesize,
                yun_ftitle:yun_ftitle,
                yun_ftitlesize:yun_ftitlesize,
                yun_ftitlecolor:yun_ftitlecolor,
                yun_zimusize:yun_zimusize,
                yun_zimucolor:yun_zimucolor,
                yun_zimuvideo:yun_zimuvideo,
                yun_spsy:yun_spsy,
                yun_hyzt:yun_hyzt,
                stickers:stickers,
            ...
            $.ajax({
                type: "POST",
                url: "/admin/videouserliset/senior_task_order",
                data: {'data':apply_data},
                dataType: "json",
                success: function(data){
                    layer.closeAll('loading');
                    if(data.code==1){
