<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:87:"/www/wwwroot/juzhen.huizhenjiang.com/public/../application/admin/view/video/single.html";i:1667439255;s:88:"/www/wwwroot/juzhen.huizhenjiang.com/public/../application/admin/view/public/header.html";i:1660125746;s:88:"/www/wwwroot/juzhen.huizhenjiang.com/public/../application/admin/view/public/footer.html";i:1660125746;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="ibox float-e-margins">
        <div class="ibox-content">
            <div class="row" style="margin:20px 0">
                ...
                <form name="admin_list_sea" class="form-search" method="get" action="<?php echo url('single'); ?>">
                        ...
                        <tbody id="article_list">
                        	 ...
                        	 <tr  style="text-align: center;">
                                ...
                                <?php endif; ?>
                        	 	...
                        	 	<!-- <td><?php echo !empty($vo['liedui'])?$vo['liedui']:'无'; ?></td> -->
