<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:98:"/www/wwwroot/juzhen.huizhenjiang.com/public/../application/admin/view/member/member_agent_add.html";i:1665470950;s:88:"/www/wwwroot/juzhen.huizhenjiang.com/public/../application/admin/view/public/header.html";i:1660125746;s:88:"/www/wwwroot/juzhen.huizhenjiang.com/public/../application/admin/view/public/footer.html";i:1660125746;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="block-box">
            <div class="col-12">
                <div class="block font13">
                    <form class="form-horizontal" name="userAdd"  method="post" action="<?php echo url('member_agent_add'); ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <input id="fbnum" type="number" class="form-control" name="fbnum" value=0 >
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <input id="user_num" type="number" class="form-control" name="user_num" value=0>

                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">视频发布扣除：</label>
                            <div class="input-group col-sm-4">
                                <input id="user_num" type="number" class="form-control" name="fpspkc" value=0>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <input id="user_num" type="number" class="form-control" name="paiming" value=0>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <input id="user_num" type="number" class="form-control" name="hunjian" value=0>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <input id="user_num" type="number" class="form-control" name="yunwei" value=0>
